...
const FloatingButtons: FunctionComponent = () => {
    ...
    return (
        <Fragment>
            <Link
                href="#top"
                className={`fixed bottom-28 right-11 rounded-full aspect-square p-3 cursor-pointer bg-black bg-opacity-25 hover:bg-opacity-40 ${showScrollToTop ? 'block' : 'hidden'}`}>
                <Image
